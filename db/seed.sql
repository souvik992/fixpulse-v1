...
INSERT INTO users (id, name, email, avatar, color) VALUES
  ('a1000000-0000-0000-0000-000000000001', 'Alice Johnson', 'alice@company.com', 'AJ', '#6366f1'),
  ('a1000000-0000-0000-0000-000000000002', 'Bob Smith',     'bob@company.com',   'BS', '#10b981'),
  ('a1000000-0000-0000-0000-000000000003', 'Carol White',   'carol@company.com', 'CW', '#f59e0b'),
  ('a1000000-0000-0000-0000-000000000004', 'David Lee',     'david@company.com', 'DL', '#ef4444')
ON CONFLICT DO NOTHING;

-- Projects
INSERT INTO projects (id, name, key, description, color) VALUES
  ('b2000000-0000-0000-0000-000000000001', 'Frontend App', 'FE',  'Customer-facing frontend', '#6366f1'),
  ('b2000000-0000-0000-0000-000000000002', 'Backend API',  'BE',  'REST API services',         '#10b981'),
  ('b2000000-0000-0000-0000-000000000003', 'Mobile App',   'MOB', 'iOS & Android app',         '#f59e0b')
ON CONFLICT DO NOTHING;
...
-- Bugs
INSERT INTO bugs (id, key, project_id, title, description, type, priority, status, assignee_id, reporter_id, labels, created_at, updated_at) VALUES
  ('c3000000-0000-0000-0000-000000000001', 'FE-1',
  ...
  ('c3000000-0000-0000-0000-000000000002', 'FE-2',
   'b2000000-0000-0000-0000-000000000001',
  ...
  ('c3000000-0000-0000-0000-000000000003', 'BE-1',
  ...
  ('c3000000-0000-0000-0000-000000000004', 'BE-2',
   'b2000000-0000-0000-0000-000000000002',
  ...
  ('c3000000-0000-0000-0000-000000000005', 'MOB-1',
  ...
  ('c3000000-0000-0000-0000-000000000006', 'FE-3',
   'b2000000-0000-0000-0000-000000000001',
