...
<body>
  ...
  function BadgeSelect({ value, onChange, options, badgeFn, iconFn }) {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      options.map((opt) => /* @__PURE__ */ React.createElement("option", { key: opt, value: opt }, iconFn ? `${iconFn(opt)} ${opt}` : opt))
    );
  }
  ...
  function BugDetail({ bugId, projects, users, onClose, onUpdate, onDelete, toast, currentUser }) {
    ...
    }))), /* @__PURE__ */ React.createElement("div", { className: "detail-sidebar" }, /* @__PURE__ */ React.createElement("div", { style: { background: "var(--surface2)", border: "1px solid var(--border)", borderRadius: "var(--radius)", padding: 16 } }, /* @__PURE__ */ React.createElement("div", { className: "detail-field" }, /* @__PURE__ */ React.createElement("div", { className: "detail-field-label" }, "Issue Type"), /* @__PURE__ */ React.createElement(BadgeSelect, { value: bug.type || "Bug", onChange: (v) => updateField("type", v), options: ["Bug", "Feature", "Task", "Improvement"], badgeFn: typeBadge, iconFn: typeIcon })), /* @__PURE__ */ React.createElement("div", { className: "detail-field" }, /* @__PURE__ */ React.createElement("div", { className: "detail-field-label" }, "Status"), /* @__PURE__ */ React.createElement(BadgeSelect, { value: bug.status || "To Do", onChange: (v) => updateField("status", v), options: ["To Do", "In Progress", "In Review", "Done"], badgeFn: statusBadge, iconFn: statusIcon })), /* @__PURE__ */ React.createElement("div", { className: "detail-field" }, /* @__PURE__ */ React.createElement("div", { className: "detail-field-label" }, "Priority"), /* @__PURE__ */ React.createElement(BadgeSelect, { value: bug.priority || "P2", onChange: (v) => updateField("priority", v), options: ["P0", "P1", "P2", "P3"], badgeFn: priorityBadge, iconFn: priorityIcon })), /* @__PURE__ */ React.createElement("div", { className: "detail-field" }, /* @__PURE__ */ React.createElement("div", { className: "detail-field-label" }, "Assignee"), /* @__PURE__ */ React.createElement("select", { className: "form-select", value: bug.assigneeId || "", onChange: (e) => updateField("assigneeId", e.target.value), disabled: !projectPermissions.has("ASSIGN_ISSUE") }, /* @__PURE__ */ React.createElement("option", { value: "" }, "Unassigned"), users.map((u) => /* @__PURE__ */ React.createElement("option", { key: u.id, value: u.id }, u.name))), !projectPermissions.has("ASSIGN_ISSUE") && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "var(--muted)", marginTop: 6 } }, "You do not have permission to reassign this issue.")), !isCompactSheetProject(project) && (() => {
...
Password: ${newCredentials.tempPassword}`) }, copied ? "\u2713 Copied" : "\u{1F4CB} Copy"))))), /* @__PURE__ */ React.createElement("div", { className: "modal-footer" }, /* @__PURE__ */ React.createElement("button", { className: "btn btn-primary", onClick: () => setNewCredentials(null) }, "Done"))), resetTarget && /* @__PURE__ */ React.createElement(Modal, { onClose: () => setResetTarget(null) }, /* @__PURE__ */ React.createElement("div", { className: "modal-header" }, /* @__PURE__ */ React.createElement("h2", { className: "modal-title" }, "Reset Password"), /* @__PURE__ */ React.createElement("button", { className: "btn-icon", onClick: () => setResetTarget(null) }, "\u2715")), /* @__PURE__ */ React.createElement("div", { className: "modal-body" }, /* @__PURE__ */ React.createElement("p", { style: { fontSize: 13, color: "var(--muted)" } }, "This will generate a new temporary password for ", /* @__PURE__ */ React.createElement("strong", null, resetTarget.name), " (", resetTarget.email, "). The old password will no longer work.")), /* @__PURE__ */ React.createElement("div", { className: "modal-footer" }, /* @__PURE__ */ React.createElement("button", { className: "btn btn-ghost", onClick: () => setResetTarget(null) }, "Cancel"), /* @__PURE__ */ React.createElement("button", { className: "btn btn-danger", onClick: () => resetPassword(resetTarget.id) }, "Reset Password"))), resetResult && /* @__PURE__ */ React.createElement(Modal, { onClose: () => setResetResult(null) }, /* @__PURE__ */ React.createElement("div", { className: "modal-header" }, /* @__PURE__ */ React.createElement("h2", { className: "modal-title" }, "\u{1F511} Password Reset"), /* @__PURE__ */ React.createElement("button", { className: "btn-icon", onClick: () => setResetResult(null) }, "\u2715")), /* @__PURE__ */ React.createElement("div", { className: "modal-body" }, /* @__PURE__ */ React.createElement("p", { style: { color: "var(--muted)", fontSize: 13, marginBottom: 16 } }, "New temporary password for ", /* @__PURE__ */ React.createElement("strong", null, resetResult.name), ":"), /* @__PURE__ */ React.createElement("div", { style: { background: "var(--surface2)", border: "1px solid var(--border)", borderRadius: 8, padding: 16 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10 } }, /* @__PURE__ */ React.createElement("code", { style: { background: "var(--bg)", border: "1px solid var(--border)", borderRadius: 6, padding: "6px 12px", fontFamily: "monospace", fontSize: 14, flex: 1 } }, resetResult.tempPassword), /* @__PURE__ */ React.createElement("button", { className: "btn btn-ghost btn-sm", onClick: () => copyToClipboard(resetResult.tempPassword) }, copied ? "\u2713 Copied" : "\u{1F4CB} Copy")))), /* @__PURE__ */ React.createElement("div", { className: "modal-footer" }, /* @__PURE__ */ React.createElement("button", { className: "btn btn-primary", onClick: () => setResetResult(null) }, "Done")))));
  ...
  function App() {
    ...
    } }, "Profile Settings"), /* @__PURE__ */ React.createElement("button", { style: { width: "100%", justifyContent: "flex-start", padding: "8px 10px", border: "none", background: "transparent", color: "var(--text)", fontSize: 13, fontWeight: 500, textAlign: "left", borderRadius: 8, cursor: "pointer" }, onMouseEnter: (e) => e.currentTarget.style.background = "var(--surface2)", onMouseLeave: (e) => e.currentTarget.style.background = "transparent", onClick: handleLogout }, "Log Out")))), /* @__PURE__ */ React.createElement("div", { className: "content" }, view === "dashboard" && /* @__PURE__ */ React.createElement(Dashboard, { projects, users, currentProject, onSelectProject: handleDashboardProjectSelect, currentUser: authUser, toast, onSyncComplete: reloadData }), view === "list" && /* @__PURE__ */ React.createElement(BugList, { projects, setProjects, users, currentProject, toast, currentUser: authUser, onSyncComplete: reloadData }), view === "projects" && /* @__PURE__ */ React.createElement(ProjectsPage, { projects, setProjects, toast, onProjectCreated: handleProjectCreated }), view === "team" && /* @__PURE__ */ React.createElement(TeamPage, { users, setUsers, bugs: allBugs, bugsLoading: allBugsLoading, setBugs: (next) => {
      setAllBugsLoaded(true);
      setAllBugs(next);
