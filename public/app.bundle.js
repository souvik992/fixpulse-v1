...
<body>
  ...
  function SyncTimestamp({ toast, onSyncComplete }) {
    ...
    return /* @__PURE__ */ React.createElement("div", { style: { marginLeft: "auto", textAlign: "right", display: "flex", alignItems: "center", gap: 12, padding: "8px 10px", border: "none", borderRadius: 12, background: "transparent" } }, isRunning && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8, fontSize: 12, color: "var(--primary)", fontWeight: 500 } }, /* @__PURE__ */ React.createElement("svg", { width: "16", height: "16", viewBox: "0 0 16 16", style: { animation: "btn-spin 1s linear infinite", flexShrink: 0 } }, /* @__PURE__ */ React.createElement("circle", { cx: "8", cy: "8", r: "6", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeDasharray: "28", strokeDashoffset: "10", strokeLinecap: "round" })), "Syncing\u2026"), !isRunning && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, fontWeight: 600, color: "var(--text)", textTransform: "uppercase", letterSpacing: "0.04em" } }, "Last Data Sync"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "var(--muted)", marginTop: 2 } }, syncDisplay)), /* @__PURE__ */ React.createElement(
      "button",
      {
        type: "button",
